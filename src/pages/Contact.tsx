    ...
    <>
      <ReplacementContainer>
        ...
        <p className="replacement-text">
          ...
          <br />
          <br />
          Estamos felizes em saber que você está interessado em entrar em
          contato conosco. Nossa equipe está pronta para ajudar e responder a
          todas as suas perguntas sobre nossos produtos e serviços.
          <br />
          <br />
          ...
          <br />
          <br />
          <strong>Por telefone:</strong> Se você preferir um contato direto,
          ligue para o número <strong>(11)94729-2964</strong> e teremos prazer
          em atendê-lo.
          <br />
          <strong>Por e-mail:</strong> Se você quiser nos enviar um e-mail,
          escreva para <strong>atendimento@cleidefabi.com.br</strong> que a
          nossa equipe responderá prontamente às suas dúvidas.
          <br />
          ...
          perfeito. Além disso, você pode nos seguir nas redes sociais para
          ficar por dentro das últimas novidades, promoçōes e inspiraçōes de
          presentes. Siga-nos no Facebook, Instagram e Twitter para se conectar
          conosco.
          <br />
          <br />
